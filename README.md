[index.html](https://github.com/user-attachments/files/28229528/index.html)
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
// ==================== OneNET 配置（辽宁平台）====================
// 请修改以下两个值
const DEVICE_ID = "2593164154";        // 你的设备ID（纯数字）
const ACCESS_KEY = "TUZNWTBwcEppa2NqWmFJTDdqb1JIc2FVQXlpQUlYUGM=";  // 你的设备密钥
// ================================================================

const PRODUCT_ID = "2S7uZdUY68";
const DEVICE_NAME = "stm32_baby_cot";
// 辽宁平台 API 地址
const API_BASE = "http://api.ln.cmcconenet.com";
...
addLog('系统初始化完成（辽宁平台 HTTP API）', 'info');
</script>
</body>
</html>
